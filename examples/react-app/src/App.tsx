...
const App: React.FC = () => {
  ...
  useEffect(() => {
    const fsSdk: IFlagship = flagship.initSdk('bn1ab7m56qolupi5sa0g', { fetchNow: true, enableConsoleLogs: true });
  ...
  visitorInstance.on('ready', () => {
    setFsVisitor(visitorInstance);
              ...
              <Alert variant="info" className="fs-alert">
                <b>NOTE:</b>
                {' '}
You can check logs generated using your browser inspect tools :)
              </Alert>
            </Alert>
          </Col>
        </Row>
        <Row>
          <Col>
            ...
            <Alert variant="dark" className="fs-alert">
              ...
              <p>
                Considering you want to customize a "add to basket" button which actually in your code looks similar to this:
              </p>
              <CodeBlock
                className="mv3"
                codeString={
              ...
              <Button variant="primary" className="mb3">Add to basket  🛒</Button>
              <p>
                Black friday event is coming, so you're looking to access modifications in order to put specific style to this button using Flagship.
                <br />
        ...
        <Row>
          <Col>
            ...
            <Alert variant="dark" className="fs-alert">
              ...
              <p>
                Continuing the previous example (Customized black friday add to basket button), let's add a hit when the user click on the button.
                <br />
                The hit will be type of
                {' '}
                <b>event</b>
              </p>
              <CodeBlock
...
>
  Add to basket  🛒
              ...
              <Alert variant="info" className="fs-alert">
                <b>NOTE:</b>
                {' '}
You can check API call using your browser inspect tools (network section) :)
              </Alert>
            </Alert>
          </Col>
        </Row>
  ...
  newVisitor: () => {
    ...
    return self;
              ...
              <Alert variant="info" className="fs-alert">
                <b>NOTE:</b>
                {' '}
This sample can be adjust according your needs.
              </Alert>
        ...
        <Row>
          <Col>
            ...
            <Alert variant="dark" className="fs-alert">
              ...
              <p>Once the SDK is initialized and a fetched of modifications has been done (fetchNow=true, getModifications() called), you can have access to the fetched data like so:</p>
              <CodeBlock
                className="mv3"
                codeString={`
