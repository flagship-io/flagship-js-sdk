    ...
    <>
      ...
      >
        ...
        <Modal.Body>
          ...
          >
            <Image src="https://storage.googleapis.com/flagship-dev-public-storage/Screenshot%20at%20Dec%2004%2016-30-28.png" fluid />
          </a>
          <h5 className="pt3">
          ...
          <a
            ...
            style={{ cursor: 'zoom-in' }}
          >
            <Image src="https://storage.googleapis.com/flagship-dev-public-storage/Screenshot%20at%20Dec%2004%2016-33-43.png" fluid />
          </a>
          <h5 className="pt3">
          ...
          <a
            ...
            style={{ cursor: 'zoom-in' }}
          >
            <Image src="https://storage.googleapis.com/flagship-dev-public-storage/Screenshot%20at%20Dec%2004%2016-34-22.png" fluid />
          </a>
          <h5 className="pt3">
            5 - Choose a use case
          </h5>
          <a
            ...
            style={{ cursor: 'zoom-in' }}
          >
            <Image src="https://storage.googleapis.com/flagship-dev-public-storage/Screenshot%20at%20Dec%2004%2016-36-11.png" fluid />
          </a>
          <h5 className="pt3">
          ...
          <a
            ...
            style={{ cursor: 'zoom-in' }}
          >
            <Image src="https://storage.googleapis.com/flagship-dev-public-storage/Screenshot%20at%20Dec%2004%2016-38-13.png" fluid />
          </a>
          <h5 className="pt3">
          ...
          <a
            ...
            style={{ cursor: 'zoom-in' }}
          >
            <Image src="https://storage.googleapis.com/flagship-dev-public-storage/Screenshot%20at%20Dec%2004%2016-39-34.png" fluid />
          </a>
          <h5 className="pt3">
          ...
          <a
            ...
            style={{ cursor: 'zoom-in' }}
          >
            <Image src="https://storage.googleapis.com/flagship-dev-public-storage/Screenshot%20at%20Dec%2004%2016-40-21.png" fluid />
          </a>
          <h2 className="pt4 tc">
            All done 👏👏
          </h2>
          <Image className="db" style={{ marginRight: 'auto', marginLeft: 'auto' }} src="https://media.giphy.com/media/XreQmk7ETCak0/giphy.gif" fluid />
        </Modal.Body>
        <Modal.Footer>
