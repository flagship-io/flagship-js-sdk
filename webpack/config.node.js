...
function DtsClean() {
    ...
    let newValue = data;
    newValue =
        newValue.slice(0, newValue.indexOf('import {', newValue.indexOf('import {') + 1)) +
        newValue.slice(newValue.indexOf(`} from './class/flagshipVisitor/flagshipVisitor.d';`), newValue.length - 1);
